...
class ProductTaxonTemplatesTest < ApplicationSystemTestCase
  setup do
    @factory_panel_product_taxon_template = factory_panel_product_taxon_templates(:one)
  end

  test "visiting the index" do
    visit factory_panel_product_taxon_templates_url
  ...
  test "creating a Product taxon template" do
    ...
    fill_in "Name", with: @factory_panel_product_taxon_template.name
