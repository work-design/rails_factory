...
class ProductTaxonsTest < ApplicationSystemTestCase
  setup do
    @admin_taxon = admin_taxons(:one)
  end

  test "visiting the index" do
    visit admin_taxons_url
  ...
  test "creating a Product taxon" do
    ...
    fill_in "Name", with: @admin_taxon.name
    fill_in "Position", with: @admin_taxon.position
    fill_in "Profit Margin", with: @admin_taxon.profit_margin
